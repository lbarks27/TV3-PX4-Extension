...
- **[Repository Architecture](docs/architecture.md)** — major components, their responsibilities, and how they fit together to accomplish the repo's goals.
...
- **[Data Visualization](docs/data_visualization.md)** — ULog replay, Rerun, PyVista, and Hawkeye tool reference.
...
./scripts/build_px4.sh --target sih    # initial PX4 SIH SITL build
...
```bash
./scripts/build_px4.sh --target nuttx cubepilot_cubeorangeplus_default
...
Log review: [docs/data_visualization.md](docs/data_visualization.md) and `./scripts/tv3_replay.sh --latest`.
