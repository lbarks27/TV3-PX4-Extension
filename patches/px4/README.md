...
The extension publishes the primary topics (`tv3_sm_status`, `tv3_lc_thrust`, `tv3_lc_eng_st`, etc.) from the TV3 modules. The patch should be refreshed when rebasing to a newer PX4 baseline.
