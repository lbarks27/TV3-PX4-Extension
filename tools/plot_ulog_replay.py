#!/usr/bin/env python3
"""TV3 ULog replay scenes: PyVista interactive 3D (default) or Rerun timed playback (--rerun)."""
...
from tools.static_preview import CAMERA_PRESETS as TRAJECTORY_CAMERA_PRESETS  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.scene == "engines":
        ...
        return plot_ulog_engines.main(_strip_scene_flag(raw_argv))
    ...
    if args.scene == "trajectory":
        ...
        from tools.static_preview import render_trajectory_preview
